...
LOCK TABLES `shipwreck` WRITE;
/*!40000 ALTER TABLE `shipwreck` DISABLE KEYS */;
INSERT INTO `shipwreck` VALUES (1,'sree','ss','ss',11,11,11,11);
/*!40000 ALTER TABLE `shipwreck` ENABLE KEYS */;
UNLOCK TABLES;
